...
function addCmdToTable(_cmd) {
    ...
    if (!isset(_cmd.type) || _cmd.type == 'action') {
        ...
        tr += '<td><input class="cmdAttr form-control input-sm" data-l1key="id" style="display: none;">';
        tr += '<input class="cmdAttr form-control input-sm" data-l1key="name"></td>';
        tr += '<td><select class="form-control cmdAttr input-sm" data-l1key="configuration" data-l2key="user"></select></td>';
